...
//         ScreenADemoView(store: store)
//       case let .screenB(store):
//         ScreenBDemoView(store: store)
//       case let .screenC(store):
//         ScreenCDemoView(store: store)
//       }
//     }
...
// // MARK: - Floating menu
// 
// private struct FloatingMenuView: View {
